...
using Octokit;
using Test_Thuyet_Trinh_Oauth2.Manages;
using Test_Thuyet_Trinh_Oauth2.Models;

namespace Test_Thuyet_Trinh_Oauth2.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        {
            var UserManager = new Test_Thuyet_Trinh_Oauth2.Manages.UserManager();
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    var userAccount = new Models.User();
        ...
        public async Task<ActionResult> GithubLogin(string code)
        {
            ...
            var parameters = new Dictionary<string, string>
            {
                ...
                { "code", code },
                { "redirect_uri", Helpers.UrlGithubRedirect() }
            };
            ...
            var client1 = new GitHubClient(new Octokit.ProductHeaderValue("ntd1683"));
